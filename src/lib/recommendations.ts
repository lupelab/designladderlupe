...
const PLAYBOOK: Record<DimensionKey, { rationale: string; low: string[]; mid: string[]; high: string[] }> = {
  visionary: {
    rationale: 'La innovación necesita un norte compartido, sponsorship visible y capacidad de ajustar estrategia cuando cambian personas y mercado.',
    low: ['Definir una visión simple de innovación y diseño centrado en las personas para la agencia.', 'Alinear a líderes en una sesión de sponsorship y criterios de decisión.', 'Elegir 2 desafíos donde la visión se traduzca en decisiones concretas.'],
    mid: ['Instalar una revisión trimestral de estrategia de innovación.', 'Pedir evidencia de personas en iniciativas prioritarias.', 'Nombrar sponsors por frente o territorio de innovación.'],
    high: ['Conectar la visión centrado en personas con portfolio y nuevas ofertas.', 'Medir impacto de innovación en crecimiento, retención o eficiencia.', 'Usar la visión como marco para decisiones de inversión y talento.'],
  },
  inspirational: {
    ...
    low: ['Organizar encuentros directos entre líderes y personas/clientes.', 'Hacer una retrospectiva sin culpa sobre un proyecto reciente.', 'Recolectar y contar un primer caso interno de diseño en acción.'],
    ...
    high: ['Convertir historias de innovación en activos de cultura interna.', 'Reconocer públicamente comportamientos centrado en personas.', 'Formar líderes como facilitadores de aprendizaje y experimentación.'],
  },
  relational: {
    ...
    high: ['Usar relaciones internas como acelerador de adopción.', 'Medir confianza y calidad de feedback entre áreas.', 'Crear comunidades internas de práctica centrado en personas.'],
  },
  identity: {
    rationale: 'La innovación se vuelve sostenible cuando pasa a formar parte de valores, decisiones de personas y representación sistemática del persona.',
    low: ['Traducir diseño centrado en las personas a comportamientos esperados por rol.', 'Incluir voz del persona en reuniones clave de proyectos.', 'Mapear el ecosistema de personas de una cuenta o servicio prioritario.'],
    mid: ['Incorporar comportamientos centrado en personas en onboarding y evaluación.', 'Crear una rutina de insights de clientes y audiencias.', 'Definir responsables de traer la voz del persona a decisiones importantes.'],
    high: ['Integrar diseño e innovación en prácticas de talento y liderazgo.', 'Convertir la voz del persona en input permanente de dirección.', 'Usar el ecosistema de personas para detectar nuevas oportunidades de negocio.'],
  },
  adoption: {
    ...
    high: ['Escalar herramientas centrado en personas a toda la agencia.', 'Medir adopción de rituales y calidad de decisiones autónomas.', 'Formar champions internos por área o agencia.'],
  },
  innovation: {
    ...
    low: ['Seleccionar un piloto pequeño para prototipar en 30 días.', 'Probar una hipótesis con personas antes de escalar.', 'Hacer una sesión cross-funcional para enriquecer una solución.'],
